...
void OpenGLWindow::initializeGL() {
  ...
  // Load default model
  loadModel(getAssetsPath() + "karambit.obj");
...
void OpenGLWindow::loadModel(std::string_view path) {
  m_model.loadDiffuseTexture(getAssetsPath() + "maps/karambit.png");
  m_model.loadNormalTexture(getAssetsPath() + "maps/karambit_normal.jpg");
